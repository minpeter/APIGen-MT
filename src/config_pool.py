...
MESSAGE_CONFIGS: List[Dict[str, Any]] = [
    {
        ...
        "messages_sent_map": {
            "USR005": {"USR006": ["Please review the attached document."], "USR007": ["Meeting at 3 PM."], "USR008": ["Lunch tomorrow?"]},
            "USR006": {"USR005": ["Got it, thanks!"], "USR007": ["Can we reschedule?"]},
            "USR007": {"USR005": ["Sure, see you then."], "USR008": ["Let's catch up soon."]},
            "USR008": {"USR006": ["I'll be there."], "USR007": ["Sounds good."]},
            "USR009": {}, "USR010": {}, "USR011": {}, "USR012": {}, "USR013": {}, "USR014": {},
        },
        "messages_inbox_map": {
            "USR005": {"USR006": ["Got it, thanks!"], "USR007": ["Sure, see you then."]},
            "USR006": {"USR005": ["Please review the attached document."], "USR008": ["I'll be there."]},
            "USR007": {"USR005": ["Meeting at 3 PM."], "USR006": ["Can we reschedule?"]},
            "USR008": {"USR005": ["Lunch tomorrow?"], "USR007": ["Let's catch up soon."]},
            "USR009": {}, "USR010": {}, "USR011": {}, "USR012": {}, "USR013": {}, "USR014": {},
        },
    ...
    },
    {
        ...
        "messages_sent_map": {
            "USR101": {"USR102": ["Can you review the PR?", "Updated the branch."], "USR103": ["Standup at 10."]},
            "USR102": {"USR101": ["Looks good, approved."]},
            "USR103": {"USR104": ["Can you deploy to staging?"]},
            "USR104": {},
        },
        "messages_inbox_map": {
            "USR101": {"USR102": ["Looks good, approved."]},
            "USR102": {"USR101": ["Can you review the PR?", "Updated the branch."]},
            "USR103": {"USR101": ["Standup at 10."]},
            "USR104": {"USR103": ["Can you deploy to staging?"]},
        },
    ...
    },
    {
        ...
        "messages_sent_map": {
            "USR201": {"USR202": ["Assignment deadline extended to Friday."], "USR203": ["Please submit your project."]},
            "USR202": {"USR203": ["Want to study together?"], "USR204": ["Did you finish the reading?"]},
            "USR203": {"USR201": ["Will submit by tonight."]},
            "USR204": {"USR202": ["Yes, chapters 5-8."]},
            "USR205": {},
            "USR206": {},
        },
        "messages_inbox_map": {
            "USR201": {"USR203": ["Will submit by tonight."]},
            "USR202": {"USR201": ["Assignment deadline extended to Friday."], "USR204": ["Did you finish the reading?"]},
            "USR203": {"USR201": ["Please submit your project."], "USR202": ["Want to study together?"]},
            "USR204": {"USR202": ["Yes, chapters 5-8."]},
            "USR205": {},
            "USR206": {},
        },
        "message_count": 6, "current_user": "",
    },
    {
        "workspace_id": "WS_FAMILY_001", "user_count": 5,
        "user_map": {"Mom": "USR301", "Dad": "USR302", "Alex": "USR303", "Sam": "USR304", "Grandma": "USR305"},
        "messages_sent_map": {
            "USR301": {"USR303": ["Don't forget dinner at 7."], "USR304": ["Bring your jacket."]},
            "USR302": {"USR303": ["Can you help with the computer?"]},
            "USR303": {"USR301": ["I'll be there!"]},
            "USR304": {"USR301": ["Yes mom."]},
            "USR305": {},
        },
        "messages_inbox_map": {
            "USR301": {"USR303": ["I'll be there!"], "USR304": ["Yes mom."]},
            "USR302": {},
            "USR303": {"USR301": ["Don't forget dinner at 7."], "USR302": ["Can you help with the computer?"]},
            "USR304": {"USR301": ["Bring your jacket."]},
            "USR305": {},
        },
        "message_count": 5, "current_user": "",
    },
    {
        ...
        "messages_sent_map": {
            "USR401": {"USR402": ["Investor meeting tomorrow."], "USR403": ["New mockups needed."]},
            "USR402": {"USR401": ["API is ready for demo."]},
            "USR403": {"USR402": ["Design specs are in Figma."]},
        },
        "messages_inbox_map": {
            "USR401": {"USR402": ["API is ready for demo."]},
            "USR402": {"USR401": ["Investor meeting tomorrow."], "USR403": ["Design specs are in Figma."]},
            "USR403": {"USR401": ["New mockups needed."]},
        },
...
FILESYSTEM_CONFIGS: List[Dict[str, Any]] = [
    {
        "root": {
                        ...
                        "contents": {
                            ...
                            "projects": {
                                ...
                                "contents": {
                                    "alpha": {
                                        "type": "directory",
                                        "contents": {"config.json": {"type": "file", "content": '{"version": "1.0", "debug": false, "port": 8080}'}},
                                    }
                                },
                            },
            ...
            "tmp": {"type": "directory", "contents": {"temp_log.txt": {"type": "file", "content": "Process started at 09:00\nProcess completed at 17:30\nNo errors detected."}}},
        }
    },
    {
        "root": {
                        ...
                        "contents": {
                            "code": {
                                ...
                                "contents": {
                                    ...
                                    "tests": {
                                        "type": "directory",
                                        "contents": {"test_main.py": {"type": "file", "content": "from main import hello\n\ndef test_hello():\n    hello()"}},
                                    },
                                },
                            },
                            "data": {
                        ...
                        "contents": {
                            "photos": {
                                ...
                                "contents": {
                                    ...
                                    "family": {
                                        "type": "directory",
                                        "contents": {"holiday.jpg": {"type": "file", "content": "[binary: holiday photo 3.1MB]"}},
                                    },
                                },
                            },
                            "documents": {
